...
export const servicesContent: Record<Lang, ServicesContent> = {
  ...
  ar: {
    hero: {
      eyebrow: 'تأجير المعدات لقطاعات المشاريع الحيوية',
    ...
    process: {
      ...
      description:
        'تم تصميم آلية العمل لمساعدة فرق المشاريع على تحديد المعدات المناسبة بسرعة حسب القطاع ونوع العملية.',
      steps: [
        {
    ...
    cta: {
      title: 'هل تحتاج معدات لقطاع مشروع محدد؟',
      description:
