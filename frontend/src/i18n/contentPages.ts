...
export const blogLabels = {
  ...
  ar: {
    ...
    heroDescription:
      'خلاصة خبرتنا في الميدان، مكتوبة لمن يتّخذ القرار: كيف تختار المعدّة الصحيحة، وتخطّط التأجير بذكاء، وتحافظ على مواقع أكثر أماناً وإنتاجية، من أول حفّارة حتى تسليم المشروع.',
...
export const projectLabels = {
  ...
  ar: {
    ...
    heroTitle: 'مشاريع انجزت بمعداتنا',
    heroDescription:
      'تجارب شركات المقاولات في مختلف أنحاء الإمارات، حيث رافقناهم من التخطيط والتجهيز حتى التنفيذ.',
...
const blogTranslations: Record<string, BlogTranslation> = {
  ...
  'reliable-fleet-support-infrastructure-projects': {
    title: 'أهمية الأسطول في مشاريع البنية التحتية',
    description:
...
const projectTranslations: Record<string, ProjectTranslation> = {
  ...
  'earthmoving-fleet-support-large-scale-construction': {
    ...
    excerpt:
      ' أسطول تأجير عملي لدعم الحفر الكمي والتسوية ونقل المواد في نطاق بناء كبير.',
  ...
  'industrial-site-preparation-heavy-machinery-rental': {
    ...
    excerpt:
      '  تأجير معدات لأعمال التنظيف والتسوية وتجهيز موقع تطوير صناعي.',
    category: 'الصناعة',
