...
const csrPageContent: Record<Lang, CsrPageCopy> = {
  ...
  ar: {
    ...
    excerpt:
      'في MYSH، نؤمن بأن الآلة الموثوقة تبدأ بممارسةٍ مسؤولة. نرافق مقاولي الإمارات بتأجيرٍ يضع السلامة أولاً، ويستثمر كل ساعة تشغيل، ويبني ثقةً تمتد بامتداد المشاريع.',
    pillars: [
      {
        heading: 'تنسيق يركز على السلامة',
        body: 'من طلب التأجير الأول حتى تسليم الموقع، نحرص على وضوح التواصل ودقّة اختيار المعدّات، ليعمل فريقك في بيئةٍ منظّمة تُستخدم فيها كل معدّة في سياقها الصحيح.',
      },
      {
